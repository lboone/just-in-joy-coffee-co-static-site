document.addEventListener("DOMContentLoaded", function () {
  const ENV = "PROD";
  let homeSwiper, featuredDrinks, shoutOuts, socials, gallery, eventsUrl, foo;
  ...
  if (ENV === "DEV") {
    ...
    homeSwiper = "/api/v1/home-swipers/get/active";
    featuredDrinks = "/api/v1/featured-drinks/get/active";
    shoutOuts = "/api/v1/shout-outs/get/active";
    socials = "/api/v1/socials/get/active";
    gallery = "/api/v1/gallery/get/active";
    eventsUrl = "/api/v1/events/upcoming";
  }
